...
function App() {
  ...
  function handleSelectPlace(id) {
    ...
    let storedId = JSON.parse(localStorage.getItem("selectedPlaces")) || [];
    console.log(storedId);
    if (storedId.indexOf(id) === -1) {
      console.log(storedId);
      localStorage.setItem("selectedPlaces", JSON.stringify([id, ...storedId]));
    }
    // storedId = JSON.parse(localStorage.getItem("selectedPlaces")) || [];
    // console.log(storedId);
  }
    ...
    <>
      ...
      <main>
        ...
        <Places
          ...
          fallbackText="No places available for the moment.sorting places by distance..."
